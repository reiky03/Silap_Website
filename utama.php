...
if (isset($_POST['simpan'])) {
  ...
  if ($komentar == '') {
      $gagal_Isian = "Isian komentar tidak boleh kosong.";
  } elseif ($wordCount > 50) {
      $gagal_Isian = "Komentar tidak boleh lebih dari 20 kata.";
  } else {
      $query = mysqli_query($koneksi, "INSERT INTO saran (id, tkomentar) VALUES (NULL, '$komentar')");

      if ($query) {
          $berhasil = "Terima kasih, saran Anda telah kami terima.";
      } else {
          $gagal = "Maaf, Anda gagal mengirimkan saran.";
      }
  }
}
...
<head>
  ...
  <script>
        function validateComment() {
            ...
            const wordCount = komentar.split(/\s+/).length;

            if (wordCount > 50) {
                alert('Komentar tidak boleh lebih dari 20 kata.');
                return false;
            }
            return confirm('Apakah Anda ingin mengirimkan saran?');
        }
    </script>
  <link rel="icon" href="Sisi User/img/SILAP.png" type="image/x-icon">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" 
  rel="stylesheet" integrity="sha384-9ndCyUaIbzAi2FUVXJi0CjmCapSmO7SnpJef0486qhLnuZ2cdeRhO02iuK6FUUVM" 
  crossorigin="anonymous">
  <link rel="stylesheet" href="Sisi User/css/style.css" />
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-right" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link px-lg-3 mx-lg-3" href="Sisi User/lokasi.php">Lokasi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-lg-3 mx-lg-3" href="Sisi User/jadwal.php">Jadwal</a>
          </li>
          <li class="nav-item">
  ...
  <section class="container-fluid navi">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-center align-items-center pt-3">
        <div class="mx-auto">
          <img class="w-75" src="Sisi User/img/Lovepik_com-401772836-medical-health.png" alt="doctor" />
        </div>
      </div>
    </div>
  </section>
...
<h3 class="container title-layanan text-center md-10" id="layanan">Layanan Khusus</h3>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-4 hover">
                <div class="card p-1 shadow-sm bg-body  ">
                    <div class="card-body">
                    <a href="#berita"><img class="content-img rounded mx-auto d-block img-fluid" src="Sisi User/img/IconPendaftaran.png" alt="" /></a>
            ...
            <div class="col-4 hover">
                <div class="card p-1 shadow-sm bg-body ">
                    <div class="card-body">
          <img class="content-img rounded mx-auto d-block img-fluid" src="Sisi User/img/Searching for location with magnifying glass.png" alt="" />
                        <h5 class="card-title"><a href="Sisi User/lokasi.php" class="fs-5 fw-semibold text-decoration-none text-dark ho">Layanan Lokasi</a></h5>
            ...
            <div class="col-4 hover">
                <div class="card p-1 shadow-sm bg-body ">
                    <div class="card-body">
          <img class="content-img rounded-4 mx-auto img-fluid" src="Sisi User/img/IconJadwal-removebg-preview.png" alt="" />
                        <h5 class="card-title"><a href="Sisi User/jadwal.php" class="fs-5 fw-semibold text-decoration-none text-dark ho">Jadwal</a></h5>
        ...
        <div class="col-sm-3 g-4 " data-aos="fade-up" data-aos-duration="1000">
          <div class="card h-100 rounded-4 ">
            ...
            <div class="card-body">
              ...
              <a href="Sisi User/berita.php?id=<?php echo $id ?>" >Read More</a>
              </button>
                ...
                <form action="" method="post" onsubmit="return validateComment()">
                    <div class="input-group w-50 mx-auto mb-3">
                        <input type="text" class="form-control" placeholder="Masukkan kritik dan saran anda disini..."
                              id="komentar" name="komentar" aria-label="Recipient's username" value="<?php echo $komentar ?>"
  ...
  <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"
    ...
    <script src="Sisi User/js/animation.js"></script>
</body>
